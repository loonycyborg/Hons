...
initNodeInfo :: Connection -> T.Text -> T.Text -> Bool -> Int64 -> B.ByteString -> Maybe B.ByteString -> Maybe Int32 -> IO ()
...
updateNodeInfo :: Connection -> Nodes -> Bool -> Int64 -> B.ByteString -> Maybe B.ByteString -> Maybe Int32 -> IO ()
